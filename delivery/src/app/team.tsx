...
const pc = StyleSheet.create({
    wrap:       { width: (width - 64) / 2, borderRadius: 18, borderWidth: 1.5, padding: 16, alignItems: 'center', marginBottom: 16, position: 'relative', overflow: 'hidden' },
...
// ─── Busca tipos do pokémon na PokeAPI ────────────────────────────────────────
...
export default function TeamScreen() {
    ...
    const loadTeam = async () => {
        try {
            ...
            if (!raw) { setError('Usuário não encontrado. Faça login novamente.'); setLoading(false); return; }
            ...
            // A API retorna { id, userId, team: [ { index, name, image } ] }
            ...
            // Busca tipos de cada pokémon em paralelo
        ...
        <View style={s.screen}>
            ...
            <View style={s.header}>
                ...
                <Link href="/battle" asChild>
                    <TouchableOpacity style={s.battleBtn}>
                        <Text style={s.battleBtnText}>⚔️</Text>
                    </TouchableOpacity>
                </Link>
            </View>
